...
<h2 style='font-size: 14px; margin: 30px 0;'>Bonjour {{$infos->userName}} {{$infos->userSurname}}</h2>
    ...
    <a href="{{route('profil')}}" style='display: block; margin: 40px auto; font-size: 16px; width: fit-content; color: white; text-decoration: none; padding: 10px 45px; background: linear-gradient(130deg,#845917,#DAC469 50%); border-radius: 15px;'>Voir mes oeuvres</a>
